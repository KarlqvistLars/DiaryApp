...
public class Day implements DayInterface {
	...
	public static boolean openDay(String day) {
		...
		DiaryWinGUI.textFieldHMIOutputText.setText(String.format("  DAG %s ÖPPNAS", DiaryWinGUI.textChoice.getText()));
		return true;
	}
	...
	public static boolean savingTheDay(String filename) {
		...
		if (filename.length() == 8) {
			...
			DiaryWinGUI.textFieldHMIOutputText.setText("   ETT FEL HAR INTRÄFFAT");
			status = false;
		}
